...
def test_ambient_rbac_isolation(
    lightkube_client, create_profile_1, create_profile_2, create_curl_pod, ops_test
):
    ...
    curl_command = [
        ...
        f"ml-pipeline.{ops_test.model.name}.svc:8888/apis/v2beta1/experiments?namespace={NAMESPACE_1}",
    ]
