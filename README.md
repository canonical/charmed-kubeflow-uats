...
2. updating the configurations of the Pod Security Admission Controller to add an exemption based on a `runtimeClass` called `uats` to its `PodSecurityConfiguration`
